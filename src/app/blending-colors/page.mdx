...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Example Request" tag="GET" label="/api/v1/blend">
      ...
      ```bash
      curl "https://mogk.io/api/v1/blend-colors?color=<HEX_ONE>&color=<HEX_TWO>&color=<HEX_THREE>"
      ```
      ...
      // PHP (using cURL)
      $ch = curl_init();
      curl_setopt($ch, CURLOPT_URL, "https://mogk.io/api/v1/blend-colors?color=%23ff0000&color=%2300ff00&color=%230000ff");
