  ...
  <Col>
   ...
   <Col sticky>
    <CodeGroup title="Making a request"  tag="GET" label="/api/v1/<ENDPOINT>">
      ```bash
      curl "https://mogk.io/api/v1/<ENDPOINT>?color=<COLOR_VALUE>"
      ```

      ```js
      fetch("https://mogk.io/api/v1/<ENDPOINT>?color=<COLOR_VALUE>")
      ...
      import requests
      response = requests.get("https://mogk.io/api/v1/<ENDPOINT>?color=<COLOR_VALUE>")
      ...
      CURLOPT_URL => "https://mogk.io/api/v1/<ENDPOINT>?color=<COLOR_VALUE>",
      ...
      uri = URI("https://mogk.io/api/v1/<ENDPOINT>?color=<COLOR_VALUE>")
...
const url = "https://mogk.io/api/colors/blend?color=${hexColor}";
