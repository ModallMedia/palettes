...
const sections = [
  ...
  //   ),
  // },
  { id: 'color-insights', title: 'Insights' },
  { id: 'color-tools', title: 'Color Tools' },
  { id: 'book-options', title: 'Book Options' },
...
export function NavBar() {
  ...
  return (
    <div ref={navBarRef} className="sticky top-0 z-[99999]">
          ...
          <>
            <div
              className={clsx(
                ...
                !open &&
                  'bg-white/95 shadow-sm [@supports(backdrop-filter:blur(0))]:bg-white [@supports(backdrop-filter:blur(0))]:backdrop-blur',
              )}
            >
              {!open && (
                <>
            ...
            <Popover.Panel className="absolute inset-x-0 top-0 bg-white py-3.5 shadow-sm [@supports(backdrop-filter:blur(0))]:bg-white [@supports(backdrop-filter:blur(0))]:backdrop-blur">
      ...
      <div className="hidden sm:flex sm:h-32 sm:justify-center sm:border-b sm:border-zinc-200 sm:bg-white sm:[@supports(backdrop-filter:blur(0))]:bg-white sm:[@supports(backdrop-filter:blur(0))]:backdrop-blur">
        <ol
          role="list"
              ...
              <a
                ...
                className={clsx(
                  ...
                  sectionIndex === activeIndex
                    ? 'border-emerald-600 bg-emerald-50 text-emerald-600 before:text-emerald-600'
                    : 'border-transparent before:text-zinc-500 hover:bg-emerald-50/40 hover:before:text-zinc-900',
                )}
              >
                {section.title}
              </a>
