...
import { Pattern } from '@/components/primer/Pattern'
...
export function FreeChapters() {
  return (
    <section
      ...
      className="scroll-mt-14 bg-emerald-600 sm:scroll-mt-32"
    >
      <div className="overflow-hidden lg:relative">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 text-lg tracking-tight text-emerald-200">
              Enter your email address and we&apos;ll send you a sample from the
              book containing a few of our favorite chapters.
            </p>
          </div>
          <form className="lg:pl-16">
            ...
            <div className="mt-4 sm:relative sm:flex sm:items-center sm:py-0.5 sm:pr-2.5">
              <div className="relative sm:static sm:flex-auto">
                ...
                />
                <div className="absolute inset-0 rounded-md border border-white/20 peer-focus:border-emerald-300 peer-focus:bg-emerald-500 peer-focus:ring-1 peer-focus:ring-emerald-300 sm:rounded-xl" />
              </div>
              <Button
                type="submit"
                color="white"
