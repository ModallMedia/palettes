...
export const navigation: Array<NavGroup> = [
  ...
  },
  {
    title: 'Endpoints',
    links: [
      { title: 'Color Name', href: '/color-name' },
      { title: 'Blending Colors', href: '/blending-colors' },
      { title: 'Color Harmony', href: '/color-harmony' },
      { title: 'Gradient Stops', href: '/gradient-stops' },
    ],
  },
]
